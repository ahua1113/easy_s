                ...
                <div class="newASource" style="width: 28%;height: 100%;float: left;background-color:#FAFAFA;margin-left: 19.8px">
                    ...
                    <div class="resource_1" style="margin-top: 5px;height: 400px;width: 100%;">
                        <div  class="theTitleOfResource" v-for="item in resourcesTableData" :key="item.id">
                            <div class="article-head" style=" cursor: pointer;margin:0px 5px ;line-height: 22px;height: 22px;text-overflow: ellipsis;
overflow: hidden;color: #000; font-weight: normal"   @click="download(item.url,item.id)">{{item.name}}</div>
                            <div style="height: 60px;overflow: hidden ;text-overflow:ellipsis;color: #999999;word-break: break-all;font-size: 14px;padding-left: 5px">
                                {{item.brief}}
                            </div>
                        </div>
        ...
        <div style="width: 29%;height: 100%;float:right;background-color: #FAFAFA;margin-bottom: 10px">
            ...
            <div class="rili" style="background-color: #00a4ff">
            ...
            <a  class="guanggao" href="https://bbs.csdn.net/topics/603764095?utm_medium=ad.590" target="_blank">
